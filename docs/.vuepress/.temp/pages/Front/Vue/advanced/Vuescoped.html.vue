<template><div><h1 id="vue中scoped和scoped穿透" tabindex="-1"><a class="header-anchor" href="#vue中scoped和scoped穿透" aria-hidden="true">#</a> Vue中scoped和scoped穿透</h1>
...
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code><span class="token selector">外层 >>> 子组件元素</span>
...
<div class="language-less ext-less line-numbers-mode"><pre v-pre class="language-less"><code><span class="token selector">外层 /deep/ 子组件元素</span> <span class="token punctuation">{</span>
    样式
<span class="token punctuation">}</span>
